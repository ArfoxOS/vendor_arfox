...
ALARM_PATH := vendor/arfox/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/arfox/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/arfox/prebuilt/common/media/audio/ringtones
